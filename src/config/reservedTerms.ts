export const frReservedTerms: Record<string, string[]> = {
	...
	"Organismes et institutions nationaux - D": ["dfp", "dpm"],
	"Organismes et institutions nationaux - E": ["eacce", "ehtp", "emi", "ena", "encg", "ensa", "ensam", "ensem", "enpl", "era", "est", "eu"],
	"Organismes et institutions nationaux - F": ["fec", "fst", "fao", "fida", "fmi"],
	"Organismes et institutions nationaux - H": ["haca", "hcp", "hcr"],
	"Organismes et institutions nationaux - I": ["iav", "imanor", "inpt", "insea", "iscae", "ismac", "isic", "ista", "ibe", "icdo", "icrc", "imo", "isesco", "iso", "itcb", "itu"],
	"Organismes et institutions nationaux - M": ["mdjs", "marocainedesjeux"],
	"Organismes et institutions nationaux - O": ["oc", "oce", "ocp", "odeco", "odep", "odi", "ofec", "ofppt", "ompic", "oncf", "onda", "onarep", "one", "onep", "onhym", "onicl", "onmt", "onp", "ont", "onts", "ormva", "ormvad", "ormval", "ormvam", "ormva-ouarzazate", "ormvah", "ormvao", "ormvag", "ormva-sm", "ormvatafilalet", "ormvat", "ormva-tf", "odco", "oadim", "ocde", "oci", "oim", "oipc", "oit", "omc", "omi", "omm", "ompi", "oms", "ong", "onu", "opep", "otan", "oua"],
	"Organismes et institutions nationaux - P": ["pm", "pnud", "pnue", "pnueh"],
	"Organismes et institutions nationaux - R": ["ram", "rcar", "rtm"],
	"Organismes et institutions nationaux - S": ["sgg", "snrt"],
	"Organismes et institutions nationaux - T": ["tpi", "tgr", "tresorduroyaume"],
	"Organismes et institutions nationaux - U": ["uae", "uca", "ucd", "uh1", "uh2c", "uit", "uiz", "um5", "umi", "ump", "usmba", "usms", "ua", "ue", "uma", "uncitral", "unesco", "unicef", "unidir", "unrwa", "upu", "usaid"],
	"Organismes et institutions nationaux - W": ["wipo", "worldbank"],
	"Pays et Continents - A": ["afghanistan", "afrique", "afrique-du-sud", "afrique-dusud", "afriquedu-sud", "afriquedusud", "albanie", "algerie", "angola", "angleterre", "antiguaetbarbuda", "arabiesaoudite", "arabie-saoudite", "argentine", "armenie", "asie", "australie", "autriche", "azerbaidjan", "allemagne", "amerique", "andorre"],
	"Pays et Continents - B": ["bahamas", "bahrein", "bangladesh", "barbade", "bhoutan", "belarus", "belgique", "belize", "benin", "bielorussie", "birmanie", "bolivie", "bosnie-herzegovine", "bosnieherzegovine", "botswana", "bresil", "brunei", "bulgarie", "burkina-faso", "burkinafaso", "burundi"],
	"Pays et Continents - C": ["cambodge", "cameroun", "canada", "centrafique", "capvert", "cap-vert", "chili", "chine", "chypre", "colombie", "comores", "congo", "coree", "coree-du-nord", "coree-du-sud", "coree-dunord", "coree-dusud", "coreedu-nord", "coreedu-sud", "coreedunord", "coreedusud", "costa-rica", "costarica", "cote-d-ivoire", "cote-divoire", "coted-ivoire", "cotedivoire", "coteivoire", "croatie", "cuba"],
	"Pays et Continents - D": ["danemark", "djibouti", "dominique"],
	"Pays et Continents - E": ["egypte", "el-salvador", "elsalvador", "emirats-arabes-unis", "emirats-arabesunis", "emiratsarabes-unis", "emiratsarabesunis", "equateur", "erythree", "espagne", "estonie", "etats-unis", "etats-unis-d-amerique", "etatsunis", "ethiopie", "europe"],
	"Pays et Continents - F": ["fidji", "finlande", "france"],
	"Pays et Continents - G": ["gabon", "gambie", "georgie", "ghana", "grande-bretagne", "grandebretagne", "grece", "grenade", "guatemala", "guinee", "guinee-bissau", "guinee-equatoriale", "guineebissau", "guineeequatoriale", "guyana"],
	"Pays et Continents - H": ["haiti", "hollande", "honduras", "hongrie"],
	"Pays et Continents - I": ["inde", "indonesie", "iran", "iraq", "irlande", "islande", "israel", "italie"],
	"Pays et Continents - J": ["jamaique", "japon", "jordanie"],
	"Pays et Continents - K": ["kazakhstan", "kenya", "kirghizistan", "kiribati", "koweit"],
	"Pays et Continents - L": ["laos", "lesotho", "lettonie", "liban", "liberia", "libye", "liechtenstein", "lituanie", "luxembourg"],
	"Pays et Continents - M": ["madagascar", "malaisie", "malawi", "maldives", "mali", "malte", "maroc", "marshall", "maurice", "mauritanie", "mexique", "micronesie", "moldavie", "moldova", "monaco", "mongolie", "mozambique"],
	"Pays et Continents - N": ["namibie", "nauru", "nepal", "nicaragua", "niger", "nigeria", "norvege", "nouvelle-zelande", "nouvellezelande"],
	"Pays et Continents - O": ["oceanie", "oman", "ouganda", "ouzbekistan"],
	"Pays et Continents - P": ["pakistan", "palaos", "palau", "panama", "papouasie-nouvelle-guinee", "papouasie-nouvelleguinee", "papouasienouvelle-guinee", "papouasienouvelleguinee", "paraguay", "pays-bas", "paysbas", "perou", "philippines", "pologne", "portuga"],
	"Pays et Continents - Q": ["qatar"],
	"Pays et Continents - R": ["roumanie", "royaume-uni", "royaumeuni", "russie", "rwanda"],
	"Pays et Continents - S": ["saint-kitts", "saint-kitts-et-nevis", "saint-marin", "saint-siege", "saint-vincent-et-les-grenadines", "sainte-lucie", "saintelucie", "saintkittnevis", "saintkitts", "saintkitts-et-nevis", "saintkittsetnevis", "saintmarin", "saintsiege", "salomon", "salvador", "samoa", "sao-tome-et-principe", "sao-tome-principe", "saotome-et-principe", "saotome-principe", "saotomeetetprincipe", "saotomeprincipe", "senegal", "serbie", "seychelles", "sierra-leone", "sierraleone", "singapour", "slovaquie", "slovenie", "somalie", "soudan", "sri-lanka", "srilanka", "suede", "suisse", "suriname", "swaziland", "syrie"],
	"Pays et Continents - T": ["tadjikistan", "tanzanie", "tchad", "tcheque", "thailande", "timor", "togo", "tonga", "trinite-et-tobago", "trinite-ettobago", "triniteet-tobago", "triniteettobago", "tunisie", "turkmenistan", "turquie", "tuvalu"],
	"Pays et Continents - U": ["ukraine", "uruguay", "usa"],
	"Pays et Continents - V": ["vanuatu", "vatican", "venezuela", "viet-nam", "vietnam"],
	"Pays et Continents - Y": ["yemen"],
