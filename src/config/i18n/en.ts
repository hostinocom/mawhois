export const enHomePage = {
    ...
    Description: {
        title: `<span class="font-semibold">"WHOIS Morocco"</span> is an <em class="italic font-serif">online directory service based on the .ma registry database</em> that enables you to search for domain name information.`,
    },
    ServiceInfo: {
